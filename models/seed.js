...
mongoose.connection.on('open', () => {
    ...
    const existingPosters = [
        {name: "Brian", location: "Quahog, Rhode Island", type: "Dog", sex: "Male", details: "went clubbing, never came back", number: 412426252725222, status: "Lost", img: "https://upload.wikimedia.org/wikipedia/en/1/12/Brian_Griffin.png" },
